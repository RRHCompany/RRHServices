...
public class UserResponse extends BaseResponse {
	...
	public UserResponse(Integer userId, String userName, String mobile,
			String trueName, String nickName, BigDecimal money, Integer gender,
			Date birthday, String smallImg, String bigImg, Date regTime,
			Date lastTime, Boolean isCertification, Integer province,
			Integer city, Integer area, String idCard, String idCardImage,
			...
			String email, String token, String goodAt, String place,
			String food, String stature, String weight, String emotion,
			String sports) {
		super();
		this.userId = userId;
