...
import com.rrh.common.PropertyUtil;
...
public class JpushWrapper implements IJpushWrapper{
	...
	public void initClient(){
		if(client == null)
			jpush_app_key = PropertyUtil.getInstance().getJpushKey();
			jpush_master_secret = PropertyUtil.getInstance().getJpushMaster();
			client = new JPushClient(jpush_master_secret, jpush_app_key);
	}
}
